    ...
    <section ref={sectionRef} className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-8 lg:px-16 py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <h1 className="mb-6">
              <span ref={milanoRef} className="hero-title-line block font-montserrat text-3xl sm:text-4xl lg:text-5xl text-[#1a1a1a] leading-[1.1] tracking-[0.02em] mb-2 inline-block text-3d-shadow">
                Milano
              </span>
              <span 
                ref={ewhRef}
      ...
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
        ...
        <div className="mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-[#1a1a1a] font-light leading-[1.1] mb-4 text-3d-shadow">
            <span ref={headerLine1Ref} className="block font-montserrat tracking-[0.02em]">Seven Models.</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl text-white font-light leading-[1.1] mb-6" style={{ textShadow: '1px 1px 0 rgba(0,0,0,0.3), 2px 2px 0 rgba(0,0,0,0.2), 3px 3px 0 rgba(0,0,0,0.1), 4px 4px 8px rgba(0,0,0,0.4)' }}>
              <span ref={headerLine1Ref} className="block font-montserrat tracking-[0.02em]">Engineering</span>
      ...
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
        <div className="mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-[#1a1a1a] font-light leading-[1.1] text-3d-shadow">
            <span ref={headerLine1Ref} className="block font-montserrat tracking-[0.02em]">Why Milano</span>
    ...
    <section id="contact" ref={sectionRef} className="relative py-24 lg:py-32 bg-[#1e293b]">
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16 text-center">
        ...
        <h2 className="text-3xl sm:text-4xl lg:text-6xl text-white font-light leading-[1.1] mb-4" style={{ textShadow: '1px 1px 0 rgba(0,0,0,0.3), 2px 2px 0 rgba(0,0,0,0.2), 3px 3px 0 rgba(0,0,0,0.1), 4px 4px 8px rgba(0,0,0,0.4)' }}>
          <span ref={headerLine1Ref} className="block font-montserrat tracking-[0.02em]">Ready for Hot Water?</span>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="mailto:info@standardgroup.ae" className="magnetic-btn group flex items-center gap-3 bg-[#2563eb] text-white px-8 py-4 rounded-full text-sm font-medium hover:bg-[#1d4ed8] transition-all duration-300 shadow-lg shadow-[#2563eb]/20">
              Request Quote
