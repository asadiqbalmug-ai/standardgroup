      ...
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
        <div className="mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-[#1a1a1a] font-light leading-[1.1] mb-4 text-3d-shadow">
            <span ref={headerLine1Ref} className="block font-montserrat tracking-[0.02em]">Three Block Types.</span>
    ...
    <section id="sands" ref={sectionRef} className="relative py-24 lg:py-32 bg-white">
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
        <div className="mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-[#1a1a1a] font-light leading-[1.1] mb-4 text-3d-shadow">
            <span ref={headerLine1Ref} className="block font-montserrat tracking-[0.02em]">Seven Grades.</span>
      ...
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              <span ref={headerLine1Ref} className="block font-montserrat tracking-[0.02em]">Built to Spec.</span>
      ...
      <div className="max-w-[1400px] mx-auto px-8 lg:px-16">
        <div className="mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl text-[#1a1a1a] font-light leading-[1.1] text-3d-shadow">
            <span ref={headerLine1Ref} className="block font-montserrat tracking-[0.02em]">Why Our Materials</span>
