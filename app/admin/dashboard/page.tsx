  ...
  return (
    <div className="max-w-6xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        {/* Total Products */}
        <Link href="/admin/dashboard/products" className="bg-white p-6 rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.04)] flex flex-col group hover:border-[#bf5e42] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all cursor-pointer">
          ...
          <span className="text-4xl font-extrabold text-[#111]">{totalProducts || 0}</span>
        </Link>
        ...
        <Link href="/admin/dashboard/products" className="bg-white p-6 rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.04)] flex flex-col group hover:border-[#bf5e42] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all cursor-pointer">
          ...
          <span className="text-4xl font-extrabold text-[#111]">{featuredCount || 0}</span>
        </Link>

        {/* Total Categories */}
        <Link href="/admin/dashboard/categories" className="bg-white p-6 rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.04)] flex flex-col group hover:border-[#bf5e42] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all cursor-pointer">
          <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-4xl font-extrabold text-[#111]">{totalCategories || 0}</span>
        </Link>

        {/* Total Brands */}
        <Link href="/admin/dashboard/brands" className="bg-white p-6 rounded-2xl border border-gray-100 shadow-[0_4px_20px_rgba(0,0,0,0.04)] flex flex-col group hover:border-[#bf5e42] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)] transition-all cursor-pointer">
          <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-4xl font-extrabold text-[#111]">{totalBrands || 0}</span>
        </Link>
