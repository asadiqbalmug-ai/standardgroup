              ...
              <table className="w-full text-left border-collapse block md:table">
                ...
                <tbody className="block md:table-row-group">
                  ...
                  {categories?.map((category) => (
                    <tr key={category.id} className="block md:table-row hover:bg-gray-50 transition-colors group bg-white border border-gray-100 md:border-b md:border-t-0 md:border-l-0 md:border-r-0 rounded-xl md:rounded-none mb-4 md:mb-0 p-4 md:p-0 shadow-sm md:shadow-none">
                      ...
                      <td className="block md:table-cell px-0 md:px-6 py-3 md:py-4 md:whitespace-nowrap flex items-center justify-between border-b border-gray-50 md:border-none">
                        <span className="md:hidden text-xs text-gray-400 font-bold uppercase">Category Name</span>
                        <span className="text-sm font-bold text-[#111]">{category.name}</span>
                      </td>
                      <td className="block md:table-cell px-0 md:px-6 py-3 md:py-4 md:whitespace-nowrap flex items-center justify-between border-b border-gray-50 md:border-none">
                        <span className="md:hidden text-xs text-gray-400 font-bold uppercase">Homepage Status</span>
                        <form action={async () => {
                          'use server'
