...
export default function CategoriesNav() {
  ...
  return (
    <div className="bg-[#091522] border-b border-[#1a2d40] py-3 px-4 md:px-8 w-full flex flex-col md:flex-row items-center gap-6">
      <div className="flex items-center gap-8 text-[14px] font-bold text-gray-200 overflow-x-auto whitespace-nowrap w-full md:w-auto md:ml-4 no-scrollbar pb-2 md:pb-0">
