        ...
        <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row gap-8 lg:gap-10 items-center">
          ...
          <div className="flex-1 w-full max-w-2xl lg:max-w-none">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Card 1 */}
              <div className="group bg-white border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 rounded-lg p-4 py-5 flex flex-col items-center justify-center text-center">
                <span className="text-3xl font-extrabold text-[#091522] group-hover:text-yellow-500 transition-colors mb-2">20+</span>
                <span className="font-bold text-gray-900 text-sm">Years of Experience</span>
                <span className="text-xs text-gray-500 mt-1">Established 2003, Abu Dhabi</span>
              </div>
              {/* Card 2 */}
              <div className="group bg-white border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 rounded-lg p-4 py-5 flex flex-col items-center justify-center text-center">
                <span className="text-3xl font-extrabold text-[#091522] group-hover:text-yellow-500 transition-colors mb-2">31+</span>
                <span className="font-bold text-gray-900 text-sm">Authorized Brands</span>
                <span className="text-xs text-gray-500 mt-1">Global & regional brands</span>
              </div>
              {/* Card 3 */}
              <div className="group bg-white border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 rounded-lg p-4 py-5 flex flex-col items-center justify-center text-center">
                <span className="text-3xl font-extrabold text-[#091522] group-hover:text-yellow-500 transition-colors mb-2">500+</span>
                <span className="font-bold text-gray-900 text-sm">Products in Stock</span>
                <span className="text-xs text-gray-500 mt-1">Across 17 categories</span>
              </div>
              {/* Card 4 */}
              <div className="group bg-white border border-gray-100 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 rounded-lg p-4 py-5 flex flex-col items-center justify-center text-center">
                <span className="text-3xl font-extrabold text-[#091522] group-hover:text-yellow-500 transition-colors mb-2">2</span>
                <span className="font-bold text-gray-900 text-sm">Showroom Locations</span>
                <span className="text-xs text-gray-500 mt-1">Baniyas West & Mafraq, AD</span>
              </div>
            </div>
          </div>
      ...
      <div className="w-full bg-[#f6c000] py-5 px-4 md:px-12 border-t border-yellow-300 shadow-inner">
        <div className="max-w-[1400px] mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
            <a href="https://wa.me/971555599508" target="_blank" rel="noopener noreferrer" className="bg-[#091522] hover:bg-black text-white font-bold py-3 px-6 rounded-md flex items-center justify-center gap-2 transition-colors w-full sm:w-auto shadow-md">
